...
.text
.globl	_whodun_packPtr_imp
.globl	_whodun_unpackPtr_imp

_whodun_packPtr_imp:
_whodun_unpackPtr_imp:
	endbr64
	movq %rdi, %rax
	ret

.globl	_whodun_packFlt_imp
...
.globl	_whodun_unpackFlt_imp

_whodun_unpackFlt_imp:
	endbr64
	subq $8, %rsp
	movq %rdi, (%rsp)
	movsd (%rsp), %xmm0
...
.globl	_whodun_atomicSet_imp

_whodun_atomicSet_imp:
	endbr64
...
.globl	_whodun_atomicSwap_imp

_whodun_atomicSwap_imp:
	endbr64
	movq %rsi, %rax
	xchg %rax, (%rdi)
	ret

.globl	_whodun_atomicCAS_imp

_whodun_atomicCAS_imp:
	endbr64
	xorq %rcx, %rcx
	movq %rsi, %rax
...
.globl	_whodun_atomicAdd_imp

_whodun_atomicAdd_imp:
	endbr64
	movq %rsi, %rax
	lock xadd %rax, (%rdi)
	addq %rsi, %rax
